...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/student/register-courses', function () {
        $user = auth()?->user();
        ...
        $arg = compact('user', 'student', 'courses', 'advisor');
        return view("student.register-courses", $arg);
    })->middleware('role:student');

    Route::get('/student/{target}', function ($target) {
        $user = auth()?->user();
        $student = $user?->student;
        $set = $student?->set;
        ...
        $arg = compact('user', 'set', 'student', 'courses', 'advisor');
        return view("student.$target", $arg);
    })->middleware('role:student');


    Route::get('/student/@{username}', [StudentController::class, 'profile'])->name('profile.student')->middleware('role:student');
    ...
    Route::post('/result/import', [ResultController::class, 'import'])->name('result.import');

    Route::get('/result/import', [ResultController::class, 'importForm'])->name('result.form');
});
